...
class FlexibleRateCalculatorSpec extends ObjectBehavior
{
    ...
    public function it_should_calculate_the_first_and_every_additional_item_cost_when_the_limit_is_equal_to_additional_items_number(ShipmentInterface $shipment)
    {
        $configuration = array(
            'first_item_cost'       => 1000,
            'additional_item_cost'  => 200,
