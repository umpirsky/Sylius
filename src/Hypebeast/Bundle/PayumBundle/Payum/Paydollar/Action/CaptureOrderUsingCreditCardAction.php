...
class CaptureOrderUsingCreditCardAction extends PaymentAwareAction
{
    ...
    public function execute($request)
    {
        ...
        if (empty($details)) {
            // Let ObtainCreditCardAction to render and process the form
            ...
            $details->setLang('E');
            $details->setEpMonth($obtainCreditCardRequest->getCreditCard()->getExpiryMonth());
